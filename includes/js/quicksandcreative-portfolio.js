jQuery(function($) {
  ...
  $(document).on('click', '#project_gallery_meta_box a.gallery-add', function(e) {
  ...
  $(document).on('click', '#project_gallery_meta_box a.change-image', function(e) {
  ...
  function resetIndex() {
    $('#gallery-metabox-list li').each(function(i) {
      $(this).find('input:hidden').attr('name', 'qc_gallery_id[' + i + ']');
    });
  }
  ...
  $(document).on('click', '#project_gallery_meta_box a.remove-image', function(e) {
    e.preventDefault();
